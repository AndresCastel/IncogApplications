...
namespace Incog.Wpf.CustomWindow
{
    public class WindowCloseButton : WindowButton
    {
        ...
        public WindowCloseButton()
        {
            ...
            Stream resourceStream = Application.GetResourceStream(new Uri("pack://application:,,,/Incog.Wpf.CustomWindow;component/ButtonIcons.xaml, UriKind.Relative")).Stream;
