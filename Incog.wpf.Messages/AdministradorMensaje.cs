...
namespace Incog.wpf.Messages
{
    public class AdministradorMensaje
    {
        ...
        #region Properties
        ConfigurationMessages _msgConfiguracion;
        ...
        /// <returns></returns>
        private ConfigurationMessages GetConfiguration()
        {
            ...
            ConfigurationMessages configuration = null;
            try
            {
            ...
            configuration = Utils.DeserializeObject<ConfigurationMessages>(docxml.OuterXml);
        ...
        {
            foreach (Message message in _msgConfiguracion)
            {
