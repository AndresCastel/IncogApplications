...
namespace Axede.WPF.DataPicker
{
    /// <summary>
    ...
    public class DatePickerEx : DatePicker
    {
        ...
        public static readonly RoutedEvent TodayClickEvent = EventManager.RegisterRoutedEvent(
            "TodayClick", RoutingStrategy.Bubble, typeof(RoutedEventHandler), typeof(DatePickerEx));

     
        public event RoutedEventHandler TodayClick
        {
            add { AddHandler(TodayClickEvent, value); }
            remove { RemoveHandler(TodayClickEvent, value); }
        }

      
        void RaiseTodayClickEvent()
        {
            RoutedEventArgs newEventArgs = new RoutedEventArgs(DatePickerEx.TodayClickEvent);
